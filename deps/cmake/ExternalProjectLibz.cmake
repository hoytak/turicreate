...
ExternalProject_Add(ex_libz
  ...
  URL ${CMAKE_SOURCE_DIR}/deps/src/zlib-1.2.11/
  INSTALL_DIR ${CMAKE_SOURCE_DIR}/deps/local
  CONFIGURE_COMMAND env CC=${CMAKE_C_COMPILER} "CFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${C_REAL_COMPILER_FLAGS}" "CPPFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${CPP_REAL_COMPILER_FLAGS}" ./configure --static --64 --prefix=<INSTALL_DIR>
  BUILD_IN_SOURCE 1
  BUILD_COMMAND env CC=${CMAKE_C_COMPILER} "CFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${C_REAL_COMPILER_FLAGS}" "CPPFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${CPP_REAL_COMPILER_FLAGS}" make install
