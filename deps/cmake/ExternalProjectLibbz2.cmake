...
ExternalProject_Add(ex_libbz2
  ...
  PATCH_COMMAND patch -N -p0 -i ${CMAKE_SOURCE_DIR}/deps/patches/libbz2_fpic.patch || true
  BUILD_IN_SOURCE 1
  BUILD_COMMAND env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} "CFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${C_REAL_COMPILER_FLAGS}" "CPPFLAGS=-fPIC ${ARCH_COMPILE_FLAGS} ${CPP_REAL_COMPILER_FLAGS}" make install PREFIX=<INSTALL_DIR>
  INSTALL_COMMAND "" )
endif()
