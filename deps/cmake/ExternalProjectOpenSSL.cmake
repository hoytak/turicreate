...
ExternalProject_Add(ex_libssl
  ...
  BUILD_IN_SOURCE 1
  CONFIGURE_COMMAND env SDKROOT=${CMAKE_OSX_SYSROOT} CC="${CMAKE_C_COMPILER}" ./Configure darwin64-x86_64-cc no-rc5 no-idea no-mdc2 --prefix=<INSTALL_DIR> ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_DEBUG} -Wno-everything
...
ExternalProject_Add(ex_libssl
  ...
  INSTALL_DIR ${CMAKE_SOURCE_DIR}/deps/local
  BUILD_IN_SOURCE 1
  CONFIGURE_COMMAND env CC=${CMAKE_C_COMPILER} ./config no-rc5 no-idea no-mdc2 --prefix=<INSTALL_DIR> ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_DEBUG} -Wno-everything
