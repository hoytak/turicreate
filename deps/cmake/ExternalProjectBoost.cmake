...
if (CLANG)
  ...
  SET(cxxflags "-std=c++11 -Wno-everything ${ARCH_FLAG} ${CPP_REAL_COMPILER_FLAGS} -fvisibility=hidden -fvisibility-inlines-hidden")
  if(TC_BUILD_IOS)
...
if (WIN32 AND ${MINGW_MAKEFILES})
  ...
  SET(BOOST_BUILD_SHELL_COMMAND "rm -rf <INSTALL_DIR>/include/boost && PATH=$PATH:${CMAKE_SOURCE_DIR}/deps/local/bin C_INCLUDE_PATH=${CMAKE_SOURCE_DIR}/deps/local/include CPLUS_INCLUDE_PATH=${CMAKE_SOURCE_DIR}/deps/local/include LIBRARY_PATH=${CMAKE_SOURCE_DIR}/deps/local/lib ${OPTIONAL_SDKROOT} ./b2 -d0 -q ${ADD_BOOST_COMPILE_TOOLCHAIN} install link=static variant=release threading=multi runtime-link=static ${PLATFORM_DEFINES} cxxflags='-fPIC -std=c++11 -fvisibility=hidden -fvisibility-inlines-hidden'")
