...
ExternalProject_Add(ex_node
  ...
  CONFIGURE_COMMAND env CC=${CMAKE_C_COMPILER} CXX=${CMAKE_CXX_COMPILER} "CFLAGS=-fPIC ${CMAKE_C_FLAGS} ${CMAKE_C_FLAGS_DEBUG}" "CPPFLAGS=-fPIC ${CMAKE_CXX_FLAGS} ${CMAKE_CXX_FLAGS_DEBUG}" ./configure --prefix=${CMAKE_SOURCE_DIR}/deps/local --openssl-no-asm ${EXTRA_CONFIGURE_FLAGS}
