...
class EXPORT one_hot_encoder : public transformer_base {

  static constexpr size_t ONE_HOT_ENCODER_VERSION = 0;
  std::map<std::string, std::shared_ptr<topk_indexer>> index_map;
  bool exclude = false;
  std::map<std::string, size_t> start_index_map;
  ...
  virtual inline ~one_hot_encoder() {}
  ...
  // for other classes.
  // --------------------------------------------------------------------------
  BEGIN_CLASS_MEMBER_REGISTRATION("_OneHotEncoder")
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::init_transformer, "_options");
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::fit, "data");
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::fit_transform, "data");
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::transform, "data");
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::get_current_options);
  REGISTER_CLASS_MEMBER_FUNCTION(one_hot_encoder::list_fields);
  REGISTER_NAMED_CLASS_MEMBER_FUNCTION("_get_default_options",
                                     one_hot_encoder::get_default_options);
  REGISTER_NAMED_CLASS_MEMBER_FUNCTION("get",
                                     one_hot_encoder::get_value_from_state,
                                     "key");
