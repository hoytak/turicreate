...
REGISTER_FUNCTION(resize_image, "image",  "resized_width", "resized_height", "resized_channels", "decode")
REGISTER_FUNCTION(resize_image_sarray, "image_sarray",  "resized_width", "resized_height", "resized_channels", "decode")
