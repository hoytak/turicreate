...
Result NeuralNetworkSpecValidator::validateLayer(const Specification::NeuralNetworkLayer& layer) {
    ...
    switch(layer.layer_case()) {
        ...
        case CoreML::Specification::NeuralNetworkLayer::kStackND:
            return validateStackNDLayer(layer);
        ...
        case CoreML::Specification::NeuralNetworkLayer::kSliceND:
            return validateSliceNDLayer(layer);
        ...
        case CoreML::Specification::NeuralNetworkLayer::kRange:
            return validateRangeLayer(layer);
