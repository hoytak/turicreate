...
namespace Model
{
  ...
  public:
    ...
    inline PutBucketCorsRequest& WithBucket(Aws::String&& value) { SetBucket(value); return *this;}
    ...
    inline void SetCORSConfiguration(CORSConfiguration&& value) { m_cORSConfigurationHasBeenSet = true; m_cORSConfiguration = value; }


    inline PutBucketCorsRequest& WithCORSConfiguration(const CORSConfiguration& value) { SetCORSConfiguration(value); return *this;}


    inline PutBucketCorsRequest& WithCORSConfiguration(CORSConfiguration&& value) { SetCORSConfiguration(value); return *this;}
    ...
    inline PutBucketCorsRequest& WithContentMD5(Aws::String&& value) { SetContentMD5(value); return *this;}
